...
async def main():
    parser = argparse.ArgumentParser(
        ...
        epilog='Example usage:\n'
               '  export SKIP_OPENAI_PLUGIN=True; export PYTHONPATH="${PYTHONPATH}:../../src"; uv run python -m temporal_supervisor.run_send_compliance_approval --workflow-id myworkflow\n'
    )
